...
(function () {
  ...
  const LOAD_ERROR_MESSAGE =
    "The solver failed to load. Reload the page to try again.";
  const EXAMPLES_ERROR_MESSAGE = "The example puzzles failed to load.";
  const HASH_ERROR_MESSAGE =
    "The link holds a puzzle that the page cannot read.";
  ...
  function readGrid() {
    return cells
      .map((cell) => (cell.value === "" ? EMPTY : cell.value))
      .join("");
  }
